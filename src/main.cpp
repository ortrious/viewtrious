...
public:
    ...
    int GetSettingsRenderControlTop() const {
        ...
        return GetSettingsRenderHeadingTop() + SettingsSectionHeadingHeight() + SettingsHeadingToControlGap() + labels + SettingsLabelToControlGap();
    }
