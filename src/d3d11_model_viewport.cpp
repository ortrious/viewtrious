...
void D3D11ModelViewport::Resize(GraphicsHost& host,const RECT& bounds){ResizeDepth(host,std::max(1L,bounds.right-bounds.left),std::max(1L,bounds.bottom-bounds.top));}
