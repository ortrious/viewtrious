...
float4 PSHighlight(VSOut i) : SV_TARGET { return float4(float3(250.0/255.0,194.0/255.0,72.0/255.0),.35); }
)";
}
...
void D3D11ModelViewport::Destroy() { DiscardD3D(); document_.reset(); drag_=Drag::None; homeAnimationActive_=false; width_=height_=0; selectedSnapPlane_=-1; uploadedSnapPlane_=-2; }
